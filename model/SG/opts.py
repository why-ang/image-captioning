...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='/home/sdb1/why/self-critical/len_16/data.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='/home/sdb1/why/COCO/cocobu_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/home/sdb1/why/COCO/cocobu_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='/home/sdb1/why/COCO/cocobu_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/home/sdb1/why/self-critical/len_16/data_label.h5',  
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/sdb1/why/two/SG_rl',
